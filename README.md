<div align="center">
  ...
  <sup>
    <br />
    <br />
    <a href="https://www.npmjs.com/package/vue-use">
       <img src="https://img.shields.io/npm/v/vue-use.svg" alt="npm package" />
    </a>
    <a href="https://circleci.com/gh/streamich/vue-use">
      <img src="https://img.shields.io/circleci/project/github/streamich/vue-use/master.svg" alt="CircleCI master" />
    </a>
    <a href="https://www.npmjs.com/package/vue-use">
      <img src="https://img.shields.io/npm/dm/vue-use.svg" alt="npm downloads" />
    </a>
    <a href="http://streamich.github.io/vue-use">
      <img src="https://img.shields.io/badge/demos-🚀-yellow.svg" alt="demos" />
    </a>
    <a href="https://opencollective.com/vue-use" alt="Financial Contributors on Open Collective"><img src="https://opencollective.com/vue-use/all/badge.svg?label=$$$" /></a>
    <br />
  ...
  <br />
  <br />
  <pre>npm i <a href="https://www.npmjs.com/package/vue-use">vue-use</a></pre>
  <br />
  <br />
  <br />
  <br />
...
- [**Sensors**](./docs/Sensors.md)
  ...
  - [`useGeolocation`](./docs/useGeolocation.md) &mdash; tracks geo location state of user's device. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/sensors-usegeolocation--demo)
  ...
  - [`useKey`](./docs/useKey.md), [`useKeyPress`](./docs/useKeyPress.md), [`useKeyboardJs`](./docs/useKeyboardJs.md), and [`useKeyPressEvent`](./docs/useKeyPressEvent.md) &mdash; track keys. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/sensors-usekeypressevent--demo)
  - [`useLocation`](./docs/useLocation.md) &mdash; tracks page navigation bar location state.
  - [`useMedia`](./docs/useMedia.md) &mdash; tracks state of a CSS media query. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/sensors-usemedia--demo)
  - [`useMediaDevices`](./docs/useMediaDevices.md) &mdash; tracks state of connected hardware devices.
  - [`useMotion`](./docs/useMotion.md) &mdash; tracks state of device's motion sensor.
  - [`useMouse` and `useMouseHovered`](./docs/useMouse.md) &mdash; tracks state of mouse position. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/sensors-usemouse--docs)
  ...
  - [`useScroll`](./docs/useScroll.md) &mdash; tracks an HTML element's scroll position. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/sensors-usescroll--docs)
  ...
  - [`useWindowScroll`](./docs/useWindowScroll.md) &mdash; tracks `Window` scroll position. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/sensors-usewindowscroll--docs)
...
- [**UI**](./docs/UI.md)
  ...
  - [`useFullscreen`](./docs/useFullscreen.md) &mdash; display an element or video full-screen. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/ui-usefullscreen--demo)
  - [`useSpeech`](./docs/useSpeech.md) &mdash; synthesizes speech from a text string. [![][img-demo]](https://codesandbox.io/s/n090mqz69m)
  - [`useVideo`](./docs/useVideo.md) &mdash; plays video, tracks its state, and exposes playback controls. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/ui-usevideo--demo)
...
- [**Animations**](./docs/Animations.md)
  ...
  - [`useTimeoutFn`](./docs/useTimeoutFn.md) &mdash; calls given function after a timeout. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/animation-usetimeoutfn--demo)
...
- [**Side-effects**](./docs/Side-effects.md)
  ...
  - [`useDebounce`](./docs/useDebounce.md) &mdash; debounces a function. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/side-effects-usedebounce--demo)
  ...
  - [`useThrottle` and `useThrottleFn`](./docs/useThrottle.md) &mdash; throttles a function. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/side-effects-usethrottle--demo)
...
- [**State**](./docs/State.md)
  ...
  - [`useCounter` and `useNumber`](./docs/useCounter.md) &mdash; tracks state of a number. [![][img-demo]](https://streamich.github.io/vue-use/?path=/story/state-usecounter--demo)
