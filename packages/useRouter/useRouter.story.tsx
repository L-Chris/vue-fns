...
import { createComponent, onMounted, onUnmounted, ref, watch } from '@vue/composition-api'
import Vue from 'vue'
...
const Docs = () => <ShowDocs md={require('./useRouter.md')} />

const Home: any = () => (
  <a key="home" href="https://github.com/u3u" target="_blank">
    <img src="https://avatars2.githubusercontent.com/u/20062482?v=4" width={100} height={100} />
  </a>
)

const About: any = () => (
  <img key="about" src="https://avatars2.githubusercontent.com/u/29977599?v=4" width={100} height={100}></img>
)

const NotFound: any = () => (
  <a key="404" href="https://github.com/egoist" target="_blank">
    <img src="https://avatars2.githubusercontent.com/u/8784712?v=4" width={100} height={100} />
  </a>
)
