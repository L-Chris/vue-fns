...
import useStore from 'vue-fns/packages/useStore/useStore';
import useState from 'vue-fns/packages/useState/useState';
import { ShowDocs } from 'vue-fns/src/components'
import { createStore } from 'vue-fns/src/mocks';
...
const Docs = () => <ShowDocs md={require('./useState.md')} />;
